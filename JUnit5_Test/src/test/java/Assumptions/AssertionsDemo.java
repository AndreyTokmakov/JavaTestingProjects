...
public class AssertionsDemo {
    ...
    void timeoutExceeded() {
    	...
    	Assertions.assertTimeout(Duration.ofMillis(10), () -> { // Simulate task that takes more than 10 ms.
            Thread.sleep(100);
        });
    }
    
    @Test
    void timeoutExceededOk() {
        // The following assertion passed
    	Assertions.assertTimeout(Duration.ofMillis(100), () -> { // Simulate task that takes more than 10 ms.
            Thread.sleep(100);
        });
    }
    ...
    void timeoutExceededWithPreemptiveTermination() {
    	...
    	Assertions.assertTimeoutPreemptively(Duration.ofMillis(10), () -> { // Simulate task that takes more than 10 ms.
