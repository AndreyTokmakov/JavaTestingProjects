...
* FakeDBParameterResolver class
*
* @name    : FakeDBParameterResolver.java
...
public class FakeDBParameterResolver implements ParameterResolver
{
	...
	private Object getFakeDBConnection(Parameter parameter,
			                           ExtensionContext extensionContext) {
		Class<?> type = parameter.getType();
		FakeDBConnection connection = extensionContext.getRoot().getStore(Namespace.GLOBAL).getOrComputeIfAbsent(FakeDBConnection.class);
